...
namespace eScatter { namespace simple { namespace camera {
    ...
    class Camera
    {
        ...
        public:
            ...
            std::unique_ptr<NdArray<real_t, 2>> render(Fn fn, shape_t<2> const &shape, std::vector<size_t> const &shuffle)
            {
                using numeric::NdRange;
                using numeric::shape_t;
                using numeric::calc_size;
            ...
            template <typename Fn>
            std::unique_ptr<NdArray<real_t, 2>> render(Fn fn, shape_t<2> const &shape)
            {
                using numeric::NdRange;
                using numeric::shape_t;
                using numeric::calc_size;
